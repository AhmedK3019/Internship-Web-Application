...
function Reportsubmission({ onBackReportsubmission }) {
    ...
    const resetForm = () => {
        ...
        setIsEditing(false);
        setAvailableCourses(availableCourses.map(course => ({ ...course, selected: false })));
    };
                                ...
                                <li key={report.id} className="report-item">
                                    <div className="report-item-header">
                                        ...
                                        <div className="report-actions">
                                            <button onClick={() => editReport(report)}className="edit-button">
                                                Edit
                                            </button>
                                            <button onClick={() => downloadReport(report)} className="download-button">
                                                Download
                                            </button>
                                            <button onClick={() => deleteReport(report.id)}className="delete-button">
                                                Delete
                                            </button>
                                        </div>
                                    </div>
                                    <p className="report-courses">
                                        <strong>Relevant Courses:</strong> {report.courses.join(', ')}
                                    </p>
                                </li>
                            ))}
                        </ul>
