    ...
    const [assessments, setAssessments] = useState([
        {
            ...
            description: "Evaluate your programming and technical skills with this comprehensive test covering various technologies.",
            duration: "45 minutes",
            deadline: "2025-06-15",
            status: "Available",
        ...
        },
        {
            ...
            description: "Assess your workplace behavior and soft skills through scenario-based questions.",
            duration: "30 minutes",
            deadline: "2025-06-20",
            status: "Available",
        ...
        },
        {
            ...
            description: "Measure your problem-solving and critical thinking skills with logical puzzles and pattern recognition.",
            duration: "60 minutes",
            deadline: "2025-05-30",
            status: "Completed",
            score: 85,
                        ...
                        filtered.map(assessment => (
                            ...
                            >
                                <div>
                                    ...
                                    <h3>{assessment.status === "Completed"
                                ...
                                {selectedId === assessment.id && (
                                    <div className="details-grid">
                                        ...
                                        <div className="detail-item">
                                            ...
                                            <span className="detail-value">{assessment.topics.join(", ")}</span>
                                        </div>
                                        <div className="detail-item">
                                        ...
                                        {assessment.status === "Completed" && (
                                            <button
                                                ...
                                                style={{
                                                    cursor: sharedAssessments.some(a => a.id === assessment.id) ? 'not-allowed' : 'pointer',
                                                    opacity: sharedAssessments.some(a => a.id === assessment.id) ? 0.6 : 1
                                                }}>
