...
function InternshipReports() {
    ...
    <div className="modal-overlay">
      <div className="modal-content">
        ...
        <div className="evaluation-details">
          ...
          <p>
            <strong>Technical Skills:</strong> {report.technicalSkillsRating} / 5
          </p>
          <p>
  ...
  const filteredReports = reports.filter((report) => {
    const matchesSearch =
      report.internshipTitle.toLowerCase().includes(searchQuery.toLowerCase()) ||
      report.studentName.toLowerCase().includes(searchQuery.toLowerCase());

    const matchesMajor = majorFilter === "All" || report.studentMajor === majorFilter;
...
const generatePDF = (report) => {
  ...
  addInlineText("Period", `${report.internshipStartDate} to ${report.internshipEndDate}`);
  ...
  doc.save(`${report.studentName.replace(/\s+/g, "_")}_Internship_Report.pdf`);
};
        ...
        {filteredReports.length === 0 ? (
          ...
          filteredReports.map((report) => (
            <div key={report.id} className="internship-card">
              ...
              <p>
                <span className="detail-label">Major:</span> {report.studentMajor}
              </p>
              <p>
